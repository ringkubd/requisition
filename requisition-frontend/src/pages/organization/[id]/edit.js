...
import { useEditOrganizationQuery, useUpdateOrganizationMutation } from "@/store/service/organization";
...
const Edit = (props) => {
    ...
    const { data, isLoading, isError } = useEditOrganizationQuery(router.query.id);
