...
import { useSingleVehicleQuery, useUpdateVehicleMutation } from "@/store/service/vehicle/VehicleAPI";
...
const Edit = (props) => {
    ...
    const { data, isLoading, isError } = useSingleVehicleQuery(router.query.id, {
        skip: !router.query.id
    })
    const {data: cashProducts, isLoading: chasProductsISLoading, isError: cashProductsISError} = useGetCashProductQuery();
                                                    ...
                                                    <div className="flex flex-row gap-4">
                                                        <div className="w-full">
                                                            ...
                                                            <Select
                                                                ...
                                                                value={cashProducts?.data?.filter((cp,index) => cp.id == values.cash_product_id)?.map((p) => ({
                                                                    value: p.id,
                                                                    label: p.title
                                                                }))[0]}
                                                            />
