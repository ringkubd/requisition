...
const View = () => {
    ...
    const {data: item, isLoading, isSuccess, isError} = useEditPurchaseQuery(id, {
        skip: !id
    });
                                ...
                                <Table>
                                    ...
                                    <Table.Body>
                                        <Table.Row>
                                            ...
                                            <Table.Cell>{data?.product?.title}</Table.Cell>
                                        </Table.Row>
                                        <Table.Row>
                                        ...
                                        <Table.Row>
                                            ...
                                            <Table.Cell>{data?.qty + ' (' + data?.product?.unit + ')'}</Table.Cell>
                                        </Table.Row>
                                        <Table.Row>
                                        ...
                                        <Table.Row>
                                            ...
                                            <Table.Cell>{data?.purchase_date}</Table.Cell>
                                        </Table.Row>
                                        <Table.Row>
                                            <Table.HeadCell>Expiry Date</Table.HeadCell>
                                            <Table.Cell>{data?.expiry_date}</Table.Cell>
                                        </Table.Row>
                                        <Table.Row>
                                            <Table.HeadCell>Available Qty.</Table.HeadCell>
                                            <Table.Cell>{data?.available_qty}</Table.Cell>
                                        </Table.Row>
                                        <Table.Row>
                                        ...
                                        <Table.Row>
                                            ...
                                            <Table.Cell>{data?.chalan_no}</Table.Cell>
                                        </Table.Row>
                                        <Table.Row>
