...
import { useEditSuppliersQuery, useUpdateSuppliersMutation } from "@/store/service/suppliers";

const Edit = (props) => {
  const router = useRouter();
  const [updateDepartment, updateResult] = useUpdateSuppliersMutation();
  const { data: supplier, isLoading, isError } = useEditSuppliersQuery(router.query.id, {
