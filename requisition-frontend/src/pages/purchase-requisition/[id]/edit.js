...
const Edit = (props) => {
    ...
    const getPurchaseRequisitionData = useSelector(state => state.purchase_requisition_inputs);
    const priceInputRef = useRef();
    const [updatePrice, updatePriceResult] = useUpdatePurchaseRequisitionPriceMutation();
            ...
            setColumns([
                ...
                },
                {
                    ...
                    selector: row => <TextInput
                        ...
                        onChange={(e) => {
                            const newRequisitionData = requisition_products.map((rd) => {
    ...
    useEffect(() => {
        const {unit_price, purchase_requisition_id, id: product_id} = priceInputRef.current?.updateRow ?? {}
                                            ...
                                            <Table>
                                                ...
                                                <Table.Body>
                                                    <Table.Row>
                                                        ...
                                                        <Table.Cell>{moment(data?.data?.created_at).format('DD MMM Y')}</Table.Cell>
                                                    </Table.Row>
                                                </Table.Body>
                                            </Table>
                                        )
