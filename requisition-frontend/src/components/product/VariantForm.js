    ...
    const optionsColumns = [
        {
            ...
            selector: row =>
                !options.isLoading && !options.isError && options.data ? (
                    <EditVariant
                        ...
                        <div className="flex flex-row gap-4">
                            <div className="w-full">
                                <div className="mb-2 block">
                                    <Label htmlFor="option_id" value="Option" />
                                </div>
                                <Creatable
                                    id="option_id"
                                    ref={selectRef}
                                    name="option_id"
                                    options={options?.data?.data.map(m => ({
                                        value: m.id,
                                        label: m.name,
                                    }))}
