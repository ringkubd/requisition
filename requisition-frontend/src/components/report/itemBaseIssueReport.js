            ...
            <table
                ...
                <tr>
                    ...
                    {columns.usage ? (
                        <th
                            scope="col"
                            className={`border bg-white leading-3 py-4 px-2 normal-case text-xs w-64`}>
                            Use Area
                        </th>
                    ) : null}
                    <th
                    ...
                    Object.keys(issues)?.map((d, i) => (
                        <>
                            <tr
                                ...
                                key={i}>
                                <td className={`border p-0`}>{i + 1}</td>
                                <td
                                    className={`border p-0 break-words text-left`}>
                                    {d}
                                </td>
                                {columns.category ? (
                                ...
                                <td>
                                    {issues[d][0].variant?.option_value}
                                </td>
                                {
                                    columns.usage ? (
                                        <td className={`border text-left max-w-2xl`}>
                                            {issues[d][0].uses_area}
                                        </td>
                                    ) : null
                                }
