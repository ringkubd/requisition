...
class PurchaseRequisitionAPIController extends AppBaseController
{
     ...
     *
     * @param PurchaseRequisition|Model $cashRequisition
     ...
     *
     * @param User $user
     * @param PurchaseRequisition $cashRequisition
     * @param string $requisitorName
     * @param string $prfNo
     * @param string|null $overridePhone
     * @return void
     */
    private function sendWhatsAppNotification(User $user, PurchaseRequisition $cashRequisition, string $requisitorName, string $prfNo, ?string $overridePhone = null): void
    {
        ...
        $user->notify(
            new WhatsAppDepartmentNotification(
                ...
                Component::quickReplyButton([$cashRequisition->id . '_' . $user->id . '_2_department_purchase']),
                Component::quickReplyButton([$cashRequisition->id . '_' . $user->id . '_3_department_purchase']),
                Component::urlButton(["/purchase-requisition/$cashRequisition->id/whatsapp_view?auth_key=" . $key->auth_key]),
                $phoneNumber
            )
        );
    }
