...
class WhatsAppWebhookController extends Controller
{
    ...
    private function processButtonMessage(stdClass $message): void
    {
        ...
        } elseif ($stage === 'department' && $type === 'purchase') {
            // Handle department approval for purchase requisitions if needed
            Log::info('Department approval for purchase requisition', compact('requisitionId', 'requisitorId', 'status'));
        } elseif ($stage === 'department' && $type === 'cash') {
