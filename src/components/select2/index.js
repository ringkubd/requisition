    ...
    return (
        <div
            ...
            <div className={`mb-4`} onClick={() => setOpen( true )}>
                ...
                <ul
                    id={ulId}
                    className={`p-2 border-2 rounded ${open ? 'border-green-500 bg-green-50' : 'hidden'
                    ...
                    {filterOptions.length ? (
                        filterOptions.map( ( o, index ) => (
                            <li
                                key={index}
                                className={`p-2 space-y-2 my-1 bg-gray-50 rounded hover:bg-green-400 hover:cursor-pointer shadow-2xl ${selectedValue === o.value
                                        ? 'bg-green-400'
                                        : ''
                                    }`}
                                value={o.value}>
