...
use App\Http\Controllers\API\ProductIssueAPIController;
...
Route::get('vehicles_yearly_report', [\App\Http\Controllers\API\VehicleHistoryAPIController::class, 'yearlyReport']);
