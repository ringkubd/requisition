...
class PurchaseRequisitionProductLiteResource extends JsonResource
{
    /**
    ...
    public function toArray(Request $request): array
    {
        return [
            ...
            'product_option' => [
                ...
                'title' => $this->product_variant?->option?->name . " (" . $this->product_variant?->option_value . ")",
                'option_name' => $this->product_variant?->option?->name,
                'option_value' => $this->product_variant?->option_value,
            ],
            'last_purchase_date' => $this->last_purchase_date,
            'last_purchase_date_formated' => $this->last_purchase_date != null
                ? Carbon::parse($this->last_purchase_date)->format('d M Y')
                : '',
