...
class PurchaseRequisitionLiteResource extends JsonResource
{
    /**
    ...
    public function toArray($request)
    {
        return [
            ...
            'purchase_requisition_products' => PurchaseRequisitionProductLiteResource::collection($this->purchaseRequisitionProducts),
